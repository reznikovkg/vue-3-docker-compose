...
export default {
  ...
  getters: {
    ...
    getLandingNetDefinitions: (state) => state.landingNetDefinitions,
    ...
    getLandingNetById: (state) => (landingNetId) => {
      const definitions = state.landingNetDefinitions || []
      return definitions.find((item) => item.id === landingNetId) || null
    },
