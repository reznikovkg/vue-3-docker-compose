...
.recorder-draft__duration {
  font-size: 14px;
  color: var(--recorder-text-muted);
}

.recorder-draft__field {
  display: flex;
  flex-direction: column;
  gap: 8px;
}

.recorder-draft__label {
  font-size: 13px;
  color: var(--recorder-text-muted);
}

.recorder-draft__input {
  padding: 10px 14px;
  border-radius: 12px;
...
.recorder-draft__audio {
  width: 100%;
}

.recorder-draft__actions {
  display: flex;
  flex-wrap: wrap;
  gap: 12px;
}

.recorder-draft__button {
  padding: 10px 18px;
  border-radius: 12px;
  font-size: 14px;
  font-weight: 500;
