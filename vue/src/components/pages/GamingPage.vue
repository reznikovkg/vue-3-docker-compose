    ...
    <div class="game__controls">
        ...
        <div class="game__movement">
            ...
            <div class="game__rotateArrow">
                <button 
                class="game__rotateArrow--btn"
                @click="() => rotateIsland('counterclockwise')">
                    <img :src="clockwiseArrow" class="game__rotateArrow--icon">
                </button>

                <button 
                class="game__rotateArrow--btn"
                @click="() => rotateIsland('clockwise')" >
            ...
            <div class="game__speedArrow">
                <button 
                class="game__speedArrow--btn"
                :class="{'accelerated': isAccelerated}"
                @click="() => accelerateFigures()" >
...
import Playing_field from './../ui/Playing_field.vue'
