<template>
    <div class="options">
        <div class="options__nav">
            <RouterLink :to="{ name: $routes.MAINMENU }" class="options__nav__link">
                Назад к игре
            </RouterLink>
        </div>
        ...
        <div class="options__grid">
            <div class="options__grid__item">
                ...
                <input type="number" min="1" max="8" step="1"  v-model.number="localSettings.totalColors" />
            ...
            <div class="options__grid__item">
                ...
                <div class="options__grid__item__color">
                    <div class="options__grid__item__color__current" @click="showColorDropdown = !showColorDropdown">
                    ...
                    <div class="options__grid__item__color__dropdown" v-if="showColorDropdown">
                        <div v-for="color in colorOptions" :key="color.value" class="options__grid__item__color__dropdown__option" :class="{ active: color.value === localSettings.targetColor }" @click="selectColor(color.value)">
            ...
            <div class="options__grid__item">
                ...
                <input type="number" min="0.1" max="5" step="0.1" v-model.number="localSettings.spawnRate" />
            ...
            <div class="options__grid__item">
                ...
                <input type="number" min="1" max="10" v-model.number="localSettings.pointsForCorrect" />
            </div>


            <div class="options__grid__item">
                <label>Очки за ошибку:</label>
                <input type="number" min="-20" max="0" v-model.number="localSettings.pointsForWrong" />
            </div>
        </div>


        <div class="options__actions">
            <button @click="() => saveSettings()" class="options__actions__btn__save">Сохранить</button>
            <button @click="() => resetToDefault()" class="options__actions__btn__reset">Сбросить</button>
        </div>
