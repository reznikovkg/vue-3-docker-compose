  ...
  <div class="game">
    ...
    <div class="game__flasks">
      ...
      >
        <div
          class="flask__tube"
          :class="{ 'flask__tube--selected': selectedFlaskIdx === fIdx }"
        >
          <div
    ...
    <div class="game__records">
      <div v-for="mode in modes" :key="mode.key" class="game__records-block">
        ...
        <ol v-if="allRecords[mode.key] && allRecords[mode.key].length > 0" class="game__records-list">
